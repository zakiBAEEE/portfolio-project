    ...
    return (
        <div className="flex flex-col w-full h-full gap-3">
            <div className="w-full bg-gray-600 flex flex-row justify-evenly p-2 rounded-2xl border-2 border-amber-50">
                <img src="fotoDiri.jpg" alt="" className="w-[120px] h-[120px] rounded-full object-cover object-center border-white border-2" />
            ...
            <div className="w-full p-4 bg-gray-600 flex flex-col justify-evenly rounded-2xl border-2 border-amber-100 ">
                ...
                <div className=" w-full justify-start ">
                    <div className="flex flex-col mb-4">
                        <p className="text-2xl font-bold">Biodata & Pengalaman</p>
                        <div className="h-1 w-64 bg-gray-300"></div>
                    </div>
                    <div className="flex flex-col gap-5">
                        ...
                        <div>
                            <p className="text-xl font-bold">Juli 2025 - Sekarang <span className="text-sm font-light">(ongoing)</span></p>
                            <p className="text-xl">Ketua Umum UKM Programming Universitas MDP</p>
                        </div>

                        <div>
                            <p className="text-xl font-bold">Juli 2025 - Sekarang <span className="text-sm font-light">(ongoing)</span></p>
                            <p className="text-xl">Anggota Senat Mahasiswa Universitas MDP</p>
                        </div>
                        ...
                        <div>
                            <p className="text-xl font-bold">September 2024 - Sekarang  <span className="text-sm font-light">(ongoing)</span></p>
                        ...
                        <div>
                            <p className="text-2xl font-bold">Kemampuan Pemrograman</p>
                            <div className="h-1 w-80 bg-gray-300 mb-4"></div>
                            <p className="text-xl mb-1">Javascript, PHP, CSS, Tailwindcss, Java, Python, Dart, Laravel React, Flutter, React-Redux, MySql, </p>
                        </div>
                        <div>
                            <p className="text-2xl font-bold ">Ketertarikan</p>
                            <div className="h-1 w-36 bg-gray-300 mb-4"></div>
                            <p className="text-xl mb-1">Menulis Blog, Koding, Anime, Machine Learning</p>
                        </div>
                        <div>
                            <p className="text-2xl font-bold ">Sosial Media</p>
                            <div className="h-1 w-36 bg-gray-300 mb-4"></div>
                            <ul>
                                <li className="text-xl mb-1">  <a href="https://instagram.com/muhammadzakyrai" className="text-blue-500 hover:underline">muhammadzakyrai</a></li>
                                <li className="text-xl mb-1">Youtube: <a href="https://youtube.com/@muhammadzakyrai" className="text-blue-500 hover:underline">@muhammadzakyrai</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
